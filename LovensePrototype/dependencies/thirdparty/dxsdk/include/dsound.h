...
DECLARE_INTERFACE_(IDirectSound, IUnknown)
{
    ...
    STDMETHOD(init)           (THIS_ __in_opt LPCGUID pcGuidDevice) PURE;
};
...
#define IDirectSound_Initialize(p,a)             (p)->init(a)
#endif // !defined(__cplusplus) || defined(CINTERFACE)
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown)
{
    ...
    STDMETHOD(init)           (THIS_ __in LPDIRECTSOUND pDirectSound, __in LPCDSBUFFERDESC pcDSBufferDesc) PURE;
...
#define IDirectSoundBuffer_Initialize(p,a,b)            (p)->init(a,b)
...
#define IDirectSoundCapture_Initialize(p,a)                 (p)->init(a)
#endif // !defined(__cplusplus) || defined(CINTERFACE)
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown)
{
    ...
    STDMETHOD(GetFormat)            (THIS_ __out_bcount_opt(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat, DWORD dwSizeAllocated, __out_opt LPDWORD pdwSizeWritten) PURE;
    STDMETHOD(GetStatus)            (THIS_ __out LPDWORD pdwStatus) PURE;
    STDMETHOD(init)           (THIS_ __in LPDIRECTSOUNDCAPTURE pDirectSoundCapture, __in LPCDSCBUFFERDESC pcDSCBufferDesc) PURE;
    STDMETHOD(Lock)                 (THIS_ DWORD dwOffset, DWORD dwBytes,
                                           __deref_out_bcount(*pdwAudioBytes1) LPVOID *ppvAudioPtr1, __out LPDWORD pdwAudioBytes1,
                                           __deref_opt_out_bcount(*pdwAudioBytes2) LPVOID *ppvAudioPtr2, __out_opt LPDWORD pdwAudioBytes2, DWORD dwFlags) PURE;
...
#define IDirectSoundCaptureBuffer_Initialize(p,a,b)             (p)->init(a,b)
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown)
{
    ...
    STDMETHOD(init)     (THIS_ __in LPCGUID pCaptureGuid, __in LPCGUID pRenderGuid, __in LPCDSCBUFFERDESC lpDscBufferDesc, __in LPCDSBUFFERDESC lpDsBufferDesc, HWND hWnd, DWORD dwLevel,
...
#else // !defined(__cplusplus) || defined(CINTERFACE)
#define IDirectSoundFullDuplex_Initialize(p,a,b,c,d,e,f,g,h)     (p)->init(a,b,c,d,e,f,g,h)
#endif // !defined(__cplusplus) || defined(CINTERFACE)
